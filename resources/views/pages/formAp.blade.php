              ...
              <section id="sectionTree" class="row justify-content-center sectionOne bg-lightM">
                ...
                <div class="col-sm12 col-md-8 col-lg-8 bg-lightM">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="nombre de caratére Max (0/600)*" id="etat_actual_du_projet" name="etat_actual_du_projet13" style="height: 100px" maxlength="600"></textarea>
                  </div>
                  <div class="form-group">
                    <br/>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="information_supplementaire23" id="information_supplementaire23" style="height: 100px" placeholder="max caratere (0/600)*" maxlength="600" required ></textarea>
                  </div>
                  <div class="form-group">
                    <br/>
